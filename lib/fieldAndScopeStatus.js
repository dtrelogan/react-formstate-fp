...
function upsertStatus(formstate, id, status, message) {
  if (message !== undefined) {
    status = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, status), {}, {
...
function setValidity(formstate, modelKey, value, message) {
  ...
  var newStatus = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, status), {}, {
    synclyValid: value
  });
...
function setAsyncFinished(asyncToken, formstate, modelKey, message, result) {
  ...
  var newStatus = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, status), {}, {
    async: (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, status.async), {}, {
      finished: Date.now()
    }, result)
  });
  return upsertStatus(formstate, id, newStatus, message);
...
function setSubmitting(formstate, modelKey) {
  ...
  var newStatus = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, status), {}, {
    touched: (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, status.touched), {}, {
