...
function setValueAndClearStatus(formstate, modelKey, value) {
  var rootModelKey = (0, _schemaAndLookup.convertToRootModelKey)(formstate, modelKey); // Have to do this in a certain order to make sure initialValue gets set correctly.

  formstate = (0, _objectSpread2["default"])({}, clearStatus(formstate, modelKey), {
    model: (0, _helperFunctions.modelAssign)(formstate.model, rootModelKey, value)
...
function setCustomProperty(formstate, modelKey, name, value) {
  var _getStatusAndId15 = getStatusAndId(formstate, modelKey),
      _getStatusAndId16 = (0, _slicedToArray2["default"])(_getStatusAndId15, 2),
      status = _getStatusAndId16[0],
      id = _getStatusAndId16[1];
