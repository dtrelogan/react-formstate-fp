...
function isFormSubmittedAndUnchanged(formstate) {
  return (0, _fieldAndScopeStatus.isSubmitted)((0, _objectSpread2["default"])({}, formstate, {
    nestedScopeId: null
  }), '');
}
...
function setFormSubmitted(formstate) {
  var submit = (0, _objectSpread2["default"])({}, formstate.formStatus.submit, {
    finished: Date.now()
  });
...
function setFormSubmissionError(formstate, error) {
  return (0, _objectSpread2["default"])({}, formstate, {
    formStatus: (0, _objectSpread2["default"])({}, formstate.formStatus, {
      submit: (0, _objectSpread2["default"])({}, formstate.formStatus.submit, {
