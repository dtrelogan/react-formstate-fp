...
function _synclyValidate(formstate, modelKey, form, id) {
  ...
  if (validationSchema.validate) {
    var nestedScopeId = formstate.nestedScopeId;
    var scopedFormstate = formstate,
        scopedForm = form;

    if (formstate.nestedScopeId !== validationSchema.nestedScopeId) {
      var _createNestedScope = (0, _schemaAndLookup.createNestedScope)(validationSchema.nestedScopeId, formstate, form);

      var _createNestedScope2 = (0, _slicedToArray2["default"])(_createNestedScope, 2);

      scopedFormstate = _createNestedScope2[0];
      scopedForm = _createNestedScope2[1];
    }

    var _result = validationSchema.validate(value, scopedFormstate, scopedForm, id);
    ...
    if ((0, _helperFunctions.isObject)(_result) && _result.model) {
      formstate = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, _result), {}, {
        nestedScopeId: nestedScopeId
      });
...
function asynclyValidate(formstate, modelKey, form) {
  ...
  if (formstate.nestedScopeId !== validationSchema.nestedScopeId) {
    var _createNestedScope3 = (0, _schemaAndLookup.createNestedScope)(validationSchema.nestedScopeId, formstate, form);

    var _createNestedScope4 = (0, _slicedToArray2["default"])(_createNestedScope3, 2);

    scopedFormstate = _createNestedScope4[0];
    scopedForm = _createNestedScope4[1];
  }

  var result = validateAsyncFunction((0, _fieldAndScopeStatus.getValue)(formstate, modelKey), scopedFormstate, scopedForm, id);
  ...
  if (!(0, _helperFunctions.isObject)(waitingFormstate) || !(0, _helperFunctions.isNonEmptyString)(asyncToken) || !(0, _helperFunctions.isObject)(promise) || !(0, _helperFunctions.exists)(promise.constructor) || promise.constructor.name !== 'Promise') {
    throw new Error(asyncResultErrorMessage);
  }

  return (0, _fieldAndScopeStatus.setPromise)((0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, waitingFormstate), {}, {
    nestedScopeId: nestedScopeId
  }), asyncToken, promise);
} //
// asynclyValidateForm
...
function addModelKey(formstate, modelKey, initialModel) {
  ...
  formstate = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, formstate), {}, {
    lookup: (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, formstate.lookup), {}, {
...
function deleteModelKey(formstate, modelKey) {
  ...
  var purgedFormstate = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, formstate), {}, {
    lookup: {
      rootModelKeysById: {},
      idsByRootModelKey: {},
      scopes: {}
  ...
  var nestedScopeId = formstate.nestedScopeId;
  formstate = (0, _objectSpread2["default"])((0, _objectSpread2["default"])({}, purgedFormstate), {}, {
    nestedScopeId: null
  });
